    ...
    <div className="flex flex-col min-h-screen bg-brand-base pb-24">
      ...
      <div className="relative w-full h-[40vh] md:h-[50vh] bg-brand-primary overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full  md:p-12">
          <div className="container mx-auto">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-5xl pl-3 font-serif text-brand-contrast leading-tight max-w-5xl">
              {title}
            </h1>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 mt-8 md:mt-12">
        <div className={`grid grid-cols-1 ${sidebar ? 'lg:grid-cols-3' : ''} gap-12 max-w-6xl mx-auto`}>
          ...
          <div className={`${sidebar ? 'lg:col-span-2' : 'col-span-1'} prose prose-lg prose-headings:font-serif prose-headings:text-brand-contrast prose-p:text-brand-contrast/80`}>
