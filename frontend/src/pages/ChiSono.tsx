...
export function ChiSono() {
  ...
  return (
    <>
      ...
      <div
        className={`flex flex-col min-h-screen transition-opacity duration-500 ${!isReady ? "opacity-0 h-screen overflow-hidden" : "opacity-100"}`}
      >
        {/* 1. Hero Section */}
        <Hero
        ...
        <section className="w-full py-24 px-4 bg-accent-green/10 text-center">
          <div className="container mx-auto max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-brand-contrast/80 leading-relaxed">
              ...
              e trasformarlo. La maternità, in particolare, mi ha insegnato la
              potenza della sorellanza e l'importanza di avere una rete di
              sostegno."
            </p>
          </div>
        </section>
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              ...
              <ul className="space-y-6">
                <li className="flex gap-4 items-start">
                  ...
                  />
                  <div>
                    <h4 className="font-serif text-xl font-medium text-brand-primary">
                ...
                <li className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="font-serif text-xl font-medium text-brand-primary">
                      Formazione in Trattamenti Olistici
                    </h4>
                    <p className="text-brand-contrast/70">
          ...
          <div className="container mx-auto max-w-6xl text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {PRACTICES.map((practice, idx) => (
                <div
                  key={idx}
                  className="bg-white/50 p-8 rounded-2xl border border-brand-primary/10 flex flex-col items-center text-center shadow-sm h-full"
                >
                  {practice.icon}
                  <h3 className="font-serif text-2xl text-brand-primary mb-4">
                    {practice.title}
                  </h3>
                  <p className="text-brand-contrast/80 leading-relaxed font-light flex-grow mb-6">
