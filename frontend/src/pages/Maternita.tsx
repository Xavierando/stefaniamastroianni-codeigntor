    ...
    async function fetchData() {
      try {
        const [servicesRes, eventsRes, reviewsRes] = await Promise.all([
          ...
          apiFetch(`/events?category=${Category.MATERNITA}&upcoming=1`),
  ...
  return (
    <>
      <SEO 
        ...
        description="Percorsi di accompagnamento alla nascita, yoga in gravidanza e sostegno al post-parto. Un viaggio dolce e consapevole verso la genitorialità."
      />
      {!isReady && (
